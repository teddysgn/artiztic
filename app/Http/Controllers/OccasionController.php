...
use App\Http\Requests\OccasionRequest as MainRequest;
 
class OccasionController extends Controller
{
    private $pathViewController = 'admin.pages.occasion.';
    private $controllerName     = 'occasion';
    private $model;
    private $params             = [];
