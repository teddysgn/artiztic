...
class CouponController extends Controller
{
    ...
    public function generate(MainRequest $request)
    {
        if($request->method() == 'POST'){
            $this->params = $request->all();
            
            $this->model->saveItem($this->params, ['task' => 'add-item-multiple']);
            return redirect()->route($this->controllerName)->with('artiz_notify', 'Added Successfully');
        }
    }
