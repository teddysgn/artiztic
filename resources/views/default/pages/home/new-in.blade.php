            ...
            <div class="row text-center">
                <div class="col-12 col-lg-12">
                    <div class="login-title mt-50">
                        <img src="{{ asset('public/default/img/core-img/result.png') }}" style="width: 10%" class="mb-5" alt="">
                        <h2>New Products coming soon</h2>                        
                        <a href="{{ route('shop') }}" class="d-flex justify-content-center mt-3">
                            <button type="button" class="btn artiz-btn" style="width: 25%">Shop Now</button>
                        </a>
                    </div>
                </div>
            </div>
