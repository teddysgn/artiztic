                                            ...
                                            <div class="col-8 col-lg-8">
                                                <div class="single_product_desc">
                                                    <div class="product-meta-data" style="position: relative">
                                                        ...
                                                        <div class="row my-2">
                                                            <div class="col-5">
                                                                <p style="font-weight: 500" class="p-0 m-0 text-primary">Tổng cộng</p>
                                                            </div>
                                                            <div class="col-7">
                            ...
                            <div class="col-12 col-lg-12 mt-5">
                                <div class="checkout_details_area clearfix">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-3">
                                            <textarea class="form-control w-100" name="note" id="note" cols="30" rows="5" placeholder="Ghi chú" style="height: 70px"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-lg-12">
                                <div class="cart-summary p-0 mt-5">
                                    ...
                                    <ul class="summary-table">
                                        ...
                                        <li><span>Phí vận chuyển:</span> <span id="shipping">Miễn phí</span></li>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(response.item != null){
                            errorCoupon.textContent         = '';
                            var total                       = Number(subtotal.textContent.replaceAll(".", "")) + Number(discount.textContent.replaceAll(".", "")) + Number(member.textContent.replaceAll(".", ""));
                            if(response.item.maximum > 0 || response.item.maximum != null){
                                var totalOrderValue             = Math.ceil(total - response.item.maximum).toLocaleString();
                                ...
                                var totalOrderValue             = Math.ceil(total * (100 - response.item.value)/100).toLocaleString();
                                successCoupon.textContent       = 'Bạn được giảm '+response.item.value+'%';
                                voucher.textContent             = '-'+Math.floor((total * response.item.value / 100)).toLocaleString().replaceAll(",", ".");
                                couponValue.value               = Math.floor((total * response.item.value / 100)).toLocaleString().replaceAll(",", ".");
                            }
