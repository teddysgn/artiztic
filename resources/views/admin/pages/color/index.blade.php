            ...
            <div class="col-lg-12 col-md-12">
                <div class="card ">
                    <div class="card-header">
                        ...
                        <a style="padding: 10px 18px" href="{{ route($controllerName) . '/form' }}" class="btn btn-sm btn-simple">Create New Color
                        </a>
                                    ...
                                    @if(count($items) > 0)
                                        @foreach($items as $key => $value)
                                            @php
                                                ...
                                                $picture        = Template::showItemThumb($controllerName, $value['picture'], $value['name'], 180);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
                                                        <div style="width: 30px; height: 30px; border-radius: 50%;">{!! $picture !!}</div>
                                                    </span>
                                                </td>
                                                <td>{!! $status !!}</td>
                                                <td>{{ $created }}</td>
