...
$name = '';
$id = $ordering = $description = $status =  '';
                ...
                <div class="col-md-7">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"> Create New Collection</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" cols="120" id="description" name="description" class="form-control" placeholder="Description">{{ $description }}</textarea>
                                    </div>
                                </div>
