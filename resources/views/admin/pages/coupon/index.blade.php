            ...
            <div class="col-lg-12 col-md-12">
                <div class="card ">
                    <div class="card-header">
                        ...
                        <a style="padding: 10px 18px" href="{{ route($controllerName) . '/form' }}" class="btn btn-sm btn-simple">Create New Coupon
                        </a>
                                    ...
                                    @if(count($items) > 0)
                                        @foreach($items as $key => $value)
                                            @php
                                                ...
                                                $maximum        = number_format($value['maximum']);
                                                $expired        = date('H:i:s d/m/Y', strtotime($value['expired']));
