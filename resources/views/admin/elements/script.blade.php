...
<script src="{{ asset('public/admin/assets/js/black-dashboard.min.js?v=1.0.0') }}" type="text/javascript"></script>
<!-- Black Dashboard DEMO methods, don't include it in your project! -->
<script src="{{ asset('public/admin/assets/demo/demo.js') }}"></script>
<script src="{{ asset('public/admin/assets/js/notify.min.js') }}"></script>
<script>
...
<script>
  var element = document.getElementById('{{ $controllerName }}').className = 'active';
</script>